...
$bal=$total-($reduce1+$reduce2+$deduction+$amount+$camount);
	 $qry=mysql_query("update  students set adminno='$adminno',degree='$degree',entry='$entry',dept='$dept',pre_degree='$pre_degree',branch='$branch',gender='$gender',address='$address',fname='$fname',dob='$dob',community='$community',income='$income',phone='$phone',district='$district',mobile='$mobile',state='$state',sslcmark='$sslcmark',sslc_per='$sslc_per',pincode='$pincode',category='$category',boardplace='$boardplace',hqualifi='$hqualifi',regno='$regno',cname='$cname',medium='$medium',caddress='$caddress',tot_mark='$tot_mark',maths='$maths',physics='$physics',chemistry='$chemistry',pcm='$pcm',cutoff='$cutoff',subj='$subj',tmark='$tmark',pmark='$pmark',degree1='$degree1',dsubj='$dsubj',dtmarks='$dtmarks',dpmarks='$dpmarks',ref_name='$ref_name',total='$total',deduction='$deduction',fees='$fees',dyear='$dyear',paid='$amount',certificate='$cert',xerox='$xerox',merit='$merit',special='$special',govt='$govt',camount='$camount',college='$college',photo='$photo',dyear1='$dyear1',dyear2='$dyear2',reduce1='$reduce1',reduce2='$reduce2',balance='$bal',graduate='$graduate' where id=$id");
if($qry)
{
...
Hostel</td>
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="ref_name" value="<?php echo $r1['ref_name']; ?>" /></td>
      <td align="left">&nbsp;</td>
      <td align="left">&nbsp;</td>
    </tr>
    <tr>
...
Management </td>
	...
	$camount1=0;
	  ...
	  ?>
        <input type="text" name="camount" value="<?php if($camount=="") { echo $r1['camount']; } else { echo $camount1; } ?>" /></td>
    </tr>
    <tr>
      <td align="left" scope="row">Total Fees</td>
      <td align="left"><input type="text" name="total" value="<?php echo $r1['total']; ?>" /></td>
      <td align="left">Deduction</td>
      <td align="left"><input type="text" name="deduction" value="<?php echo $r1['deduction']; ?>" /></td>
    </tr>
    <tr>
      ...
      <td align="left"><input type="text" name="amount" value="<?php echo $r1['paid']; ?>" /></td>
    </tr>
    <tr>
