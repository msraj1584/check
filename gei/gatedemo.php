...
<form autocomplete="off"  id="form1" name="form1" method="post" action="">
  ...
  <table width="589" border="0" align="center" cellpadding="5" cellspacing="5" class="bor">
    ...
    <tr>
	  ...
	  <span id="y11" style="display:none"><input type="text" name="refer12" /></span>
	   <span id="y111" style="display:none"><input type="text" name="refer13" /></span>
	    <span id="y1111" style="display:none"><input type="text" name="refer14" /></span>
	  </div>
	  ...
	  <span id="y22" style="display:none"><input type="text" name="refer23" /></span>
	  <span id="y222" style="display:none"><input type="text" name="refer24" /></span>
	  <span id="y2222" style="display:none"><input type="text" name="refer25" /></span>
	  </div>
	  ...
	  <span id="y3" style="display:none"><input type="text" name="refer33" Placeholder="Enter Consultancy Name" Required /></span>
	   <span id="y33" style="display:none"><input type="text" name="refer34" Placeholder="Enter Consultancy Address" Required /></span>
	   <span id="y333" style="display:none"><input type="text" name="refer35" Placeholder="Enter Mobile No"  pattern="[6789][0-9]{9}" Required /></span>
	   <span id="y3333" style="display:none"><input type="text" name="refer36" Placeholder="Enter E-Mail" Required /></span>
	  </div>
	  ...
	  <span id="y4" style="display:none"><input type="text" name="refer44" Placeholder="Enter Name" Required /></span>
	  <span id="y44" style="display:none"><input type="text" name="refer45" Placeholder="Enter Address" Required /></span>
	  <span id="y444" style="display:none"><input type="text" name="refer46" Placeholder="Enter Mobile No"pattern="[6789][0-9]{9}" Required /></span>
	  <span id="y4444" style="display:none"><input type="text" name="refer47" Placeholder="Enter E-Mail" Required /></span>
