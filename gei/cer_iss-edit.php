...
/////
			...
			{
			$cert2[]=$certificate1.":".$sdate1.":".$rea1;
			}
			if($certificate2=="12th Marksheet")
			{
			$cert2[]=$certificate2.":".$sdate2.":".$rea2;
			}
			if($certificate3=="TC")
			{
			$cert2[]=$certificate3.":".$sdate3.":".$rea3;
			}
			if($certificate4=="Degree")
			{
			$cert2[]=$certificate4.":".$sdate4.":".$rea4;
			}
			if($certificate5=="Community")
			{
			$cert2[]=$certificate5.":".$sdate5.":".$rea5
			}
			if($certificate6=="Provisional")
			{
			$cert2[]=$certificate6.":".$sdate6.":".$rea6;
			}
...
$bal=$total-($reduce1+$reduce2+$deduction+$amount+$camount);
   ...
   fees='$fees',dyear='$dyear',paid='$amount',certificate_issue='$cert',
...
Management </td>
    ...
    <tr>
      <td align="left" scope="row">Original Certificate Issued to Student</td>
      <td colspan="3" align="left" valign="top">
	  
	  <?php
	  
	  $pos=strpos($r1['certificate_issue'],"10th Marksheet");
	  $pos2=strpos($r1['certificate_issue'],"12th Marksheet");
	  $pos3=strpos($r1['certificate_issue'],"TC");
	  $pos4=strpos($r1['certificate_issue'],"Degree");
	  $pos5=strpos($r1['certificate_issue'],"Community");
	  $pos6=strpos($r1['certificate_issue'],"Provisional");
  ...
  <tr>
    ...
    <th align="left" scope="col">Date of Issued </th>
    <th align="left" scope="col">Reason </th>
  </tr>
  <tr>
    <td width="188" align="left" scope="col"><input type="checkbox" name="certificate1" value="10th Marksheet" <?php if($certificate1=="") { if($pos===false) { } else { $cdt=@explode("10th Marksheet",$r1['certificate_issue']);  $sd1=substr($cdt[1],1,10);   echo "checked"; } } else { if($certificate1=="10th Marksheet") echo "checked"; } ?> />
      10th Marksheet </td>
    <td width="326" align="left" scope="col"><input type="text" name="sdate1" id="sdate1" value="<?php if($sdate1=="") { echo $sd1; } else { echo $sdate1; } ?>" /></td>
    <td width="326" align="left" scope="col"><input type="text" name="rea1"  value="<?php if($rea1=="") { echo $rea; } else { echo $rea1; } ?>" /></td>
  </tr>
  <tr>
    <td align="left" scope="row"><br />
        <input type="checkbox" name="certificate2" value="12th Marksheet" <?php if($certificate2=="") { if($pos2===false) { } else { $cdt=@explode("12th Marksheet",$r1['certificate_issue']);  $sd2=substr($cdt[1],1,10); echo "checked"; } } else { if($certificate2=="12th Marksheet") echo "checked"; } ?> />
      12th Marksheet </td>
    <td align="left"><input type="text" name="sdate2" id="sdate2" value="<?php if($sdate2=="") { echo $sd2; } else { echo $sdate2; } ?>" /></td>
    <td width="326" align="left" scope="col"><input type="text" name="rea2"  value="<?php if($rea2=="") { echo $rea12; } else { echo $rea2; } ?>" /></td>
  </tr>
  <tr>
    <td align="left" scope="row"><input type="checkbox" name="certificate3" value="TC" <?php if($certificate3=="") { if($pos3===false) { } else { $cdt=@explode("TC",$r1['certificate_issue']);  $sd3=substr($cdt[1],1,10); echo "checked"; }  } else { if($certificate3=="TC") echo "checked"; } ?> />
      TC </td>
    <td align="left"><input type="text" name="sdate3" id="sdate3" value="<?php if($sdate3=="") { echo $sd3; } else { echo $sdate3; } ?>" /></td>

    <td width="326" align="left" scope="col"><input type="text" name="rea3"  value="<?php if($rea3=="") { echo $rea13; } else { echo $rea3; } ?>" /></td>
  </tr>
  <tr>
    <td align="left" scope="row"><input type="checkbox" name="certificate4" value="Degree" <?php if($certificate4=="") { if($pos4===false) { } else { $cdt=@explode("Degree",$r1['certificate_issue']);  $sd4=substr($cdt[1],1,10); echo "checked"; }  } else { if($certificate4=="Degree") echo "checked"; } ?>  />
      Degree </td>
    <td align="left"><input type="text" name="sdate4" id="sdate4" value="<?php if($sdate4=="") { echo $sd4; } else { echo $sdate4; } ?>" /></td>

    <td width="326" align="left" scope="col"><input type="text" name="rea4"  value="<?php if($rea4=="") { echo $rea14; } else { echo $rea4; } ?>" /></td>
  </tr>
  <tr>
    <td align="left" scope="row"><input type="checkbox" name="certificate5" value="Community" <?php if($certificate5=="") { if($pos5===false) { } else { $cdt=@explode("Community",$r1['certificate_issue']);  $sd5=substr($cdt[1],1,10); echo "checked"; }  } else { if($certificate5=="Community") echo "checked"; } ?> />
      Community </td>
    <td align="left"><input type="text" name="sdate5" id="sdate5" value="<?php if($sdate5=="") { echo $sd5; } else { echo $sdate5; } ?>" /></td>

    <td width="326" align="left" scope="col"><input type="text" name="rea5"  value="<?php if($rea5=="") { echo $rea15; } else { echo $rea5; } ?>" /></td>
  </tr>
  <tr>
    <td align="left" scope="row"><input type="checkbox" name="certificate6" value="Provisional" <?php if($certificate6=="") { if($pos6===false) { } else { $cdt=@explode("Provisional",$r1['certificate_issue']);  $sd6=substr($cdt[1],1,10); echo "checked"; }  } else { if($certificate6=="Provisional") echo "checked"; } ?> />
      Provisional </td>
    <td align="left"><input type="text" name="sdate6" id="sdate6" value="<?php if($sdate6=="") { echo $sd6; } else { echo $sdate6; } ?>" /></td>

    <td width="326" align="left" scope="col"><input type="text" name="rea6"  value="<?php if($rea6=="") { echo $rea16; } else { echo $rea6; } ?>" /></td>
  </tr>
</table></td>
    </tr>
    <tr>
