...
alert("Updated..");
window.location.href="add_chair.php";
</script>
<?php
}
?>
...
<form autocomplete="off"  id="form1" name="form1" method="post" action="">
  ...
  <table width="393" height="135" border="0" align="center" cellpadding="5" class="bor">
    ...
    <tr>
      <th width="88" align="left" scope="col">E-mail </th>
      <th width="279" align="left" scope="col"><input name="email" type="text" value="<?php echo $row['email']; ?>" size="40" /></th>
    </tr>
    <tr>
